...
<body>
    <div style="position: absolute; left: 60%; width: 30%;  height: 100px; color: #000000; top: 35%; font-family: serif; font-size: 40px; font-weight: 600;">Acer Products</div>
    ...
    <div id="solution1">
        ...
        <%
            ...
            c.add(Restrictions.eq("brand", "Acer"));
        ...
        <div id="background_box_2">
            ...
            <form action="SaveCartItem" method="GET">
                ...
                <input type="hidden" name="page_name" value="acer"/>
