...
<body>
    <div id="solution1">
        ...
        <div id="background_box_2">
            ...
            <div style="position: relative;    color: #000000; font-family: serif; font-size: 16px; padding-left: 300px; top: -196px; width: 250px; color: #000099; font-size: 24px; " > <%= price%> /-  </div>
            ...
            <form action="SaveCartItem" method="GET">
                ...
                <input type="hidden" name="page_name" value="all"/>
                ...
                <div style="position: relative; left: 480px; width: 300px; height: 300px; top: -470px; ">
                    ...
                    <!--
qty text field and submit button area....
                    -->
                  <div id="qty_1"> 

                      <input type="text" id="qty_h" name="qty_h" class="form-control" placeholder="Quantity" style="width: 170px; height: 30px; font-family: serif; font-size: 24px;" maxlength="1"   required /> 

                    </div>

                    <div style=" position: absolute; width: 170px; height: 50px; top: 250px; left: 20%; ">  

                        <input type="submit" onchange="" name="btn-4" class="btn btn-sm"  value="Add to Cart" style="width: 100px;  height: 30px;  font-size: 14px; "/>  

                    </div>

                    <!--
end of qty text field and submit button area....
                    -->

                </div>
                
                <!--
e               laptop details pane
                    -->
                    <div style="position: absolute; left: 55%; top: 16%; width: 40%; height: 25%; ">
